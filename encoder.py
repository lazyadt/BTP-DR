...
def encoder(image, centroids, W, M, fo=None,
    ...
    N = image.shape[0]     #256*97200

    # chunk to allocate on GPU
    n_chunks = np.int(np.ceil(1.0*N/chunk_size)) #6
...
def encoder2(image, centroids, W, M, fo=None,
    ...
    print 'Encoder2: chunk %d/%d' % (k+1, n_chunks)
